package co.aoscp.musicx.service;
...
import co.aoscp.musicx.appwidgets.AppWidgetBig;
import co.aoscp.musicx.appwidgets.AppWidgetCard;
import co.aoscp.musicx.appwidgets.AppWidgetClassic;
import co.aoscp.musicx.appwidgets.AppWidgetSmall;
import co.aoscp.musicx.glide.BlurTransformation;
import co.aoscp.musicx.glide.SongGlideRequest;
import co.aoscp.musicx.helper.ShuffleHelper;
import co.aoscp.musicx.helper.StopWatch;
import co.aoscp.musicx.loader.PlaylistSongLoader;
import co.aoscp.musicx.model.AbsCustomPlaylist;
import co.aoscp.musicx.model.Playlist;
import co.aoscp.musicx.model.Song;
import co.aoscp.musicx.provider.HistoryStore;
import co.aoscp.musicx.provider.MusicPlaybackQueueStore;
import co.aoscp.musicx.provider.SongPlayCountStore;
import co.aoscp.musicx.service.notification.PlayingNotification;
import co.aoscp.musicx.service.notification.PlayingNotificationImpl;
import co.aoscp.musicx.service.notification.PlayingNotificationImpl24;
import co.aoscp.musicx.service.playback.Playback;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "co.aoscp.musicx" + ".temp_sticky_intent_fix"; // TODO remove ".temp_sticky_intent_fix" in a future update.
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("co.aoscp.musicx.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("co.aoscp.musicx.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
