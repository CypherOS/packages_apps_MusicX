package co.aoscp.musicx.ui.activities;
...
import co.aoscp.musicx.adapter.album.HorizontalAlbumAdapter;
import co.aoscp.musicx.adapter.song.ArtistSongAdapter;
import co.aoscp.musicx.dialogs.AddToPlaylistDialog;
import co.aoscp.musicx.dialogs.SleepTimerDialog;
import co.aoscp.musicx.glide.PhonographColoredTarget;
import co.aoscp.musicx.glide.artistimage.ArtistImage;
import co.aoscp.musicx.glide.palette.BitmapPaletteTranscoder;
import co.aoscp.musicx.glide.palette.BitmapPaletteWrapper;
import co.aoscp.musicx.helper.MusicPlayerRemote;
import co.aoscp.musicx.interfaces.CabHolder;
import co.aoscp.musicx.interfaces.LoaderIds;
import co.aoscp.musicx.interfaces.PaletteColorHolder;
import co.aoscp.musicx.lastfm.rest.LastFMRestClient;
import co.aoscp.musicx.lastfm.rest.model.LastFmArtist;
import co.aoscp.musicx.loader.ArtistLoader;
import co.aoscp.musicx.misc.SimpleObservableScrollViewCallbacks;
import co.aoscp.musicx.misc.WrappedAsyncTaskLoader;
import co.aoscp.musicx.model.Artist;
import co.aoscp.musicx.model.Song;
import co.aoscp.musicx.ui.activities.base.AbsSlidingMusicPanelActivity;
