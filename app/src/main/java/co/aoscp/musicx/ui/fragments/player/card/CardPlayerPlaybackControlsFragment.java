...
import co.aoscp.musicx.helper.MusicProgressViewUpdateHelper;
import co.aoscp.musicx.helper.PlayPauseButtonOnClickHandler;
import co.aoscp.musicx.misc.SimpleOnSeekbarChangeListener;
...
import co.aoscp.musicx.views.PlayPauseDrawable;
...
public class CardPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        playPauseFab = (FloatingActionButton) view.findViewById(R.id.player_play_pause_fab);
