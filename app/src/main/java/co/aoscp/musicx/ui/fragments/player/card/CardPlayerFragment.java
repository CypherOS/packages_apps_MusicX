package co.aoscp.musicx.ui.fragments.player.card;
...
import co.aoscp.musicx.adapter.song.PlayingQueueAdapter;
...
import co.aoscp.musicx.ui.fragments.player.PlayerAlbumCoverFragment;
import co.aoscp.musicx.util.MusicUtil;
import co.aoscp.musicx.util.Util;
import co.aoscp.musicx.util.ViewUtil;
import co.aoscp.musicx.views.WidthFitSquareLayout;
