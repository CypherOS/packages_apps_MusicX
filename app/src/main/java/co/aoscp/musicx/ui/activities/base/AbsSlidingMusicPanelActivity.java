package co.aoscp.musicx.ui.activities.base;
...
import co.aoscp.musicx.ui.fragments.player.AbsPlayerFragment;
import co.aoscp.musicx.ui.fragments.player.MiniPlayerFragment;
import co.aoscp.musicx.ui.fragments.player.NowPlayingScreen;
import co.aoscp.musicx.ui.fragments.player.card.CardPlayerFragment;
import co.aoscp.musicx.ui.fragments.player.flat.FlatPlayerFragment;
...
public abstract class AbsSlidingMusicPanelActivity extends AbsMusicServiceActivity implements SlidingUpPanelLayout.PanelSlideListener, CardPlayerFragment.Callbacks {
    ...
    protected View wrapSlidingMusicPanel(@LayoutRes int resId) {
        ...
        ViewGroup contentContainer = (ViewGroup) slidingMusicPanelLayout.findViewById(R.id.content_container);
