package co.aoscp.musicx.appshortcuts.shortcuttype;
...
import co.aoscp.musicx.appshortcuts.AppShortcutLauncherActivity;
...
public abstract class BaseShortcutType {
    ...
    static final String ID_PREFIX = "co.aoscp.musicx.appshortcuts.id.";
